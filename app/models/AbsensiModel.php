...
class AbsensiModel
{
    ...
    {
        $query = "SELECT a.id_absensi, a.kode_absensi, a.nip, a.id_kegiatan, a.status_kehadiran, a.alasan_tidak_hadir, a.created_at, a.foto, a.file_bukti, a.tipe_file_bukti,
                         p.nama_lengkap, 
