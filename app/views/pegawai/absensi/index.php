...
<div class="card abs-card stagger-1">
    <div class="card-body">
        ...
        <p class="text-muted" style="margin-bottom: 2rem;">Silakan isi formulir di bawah ini untuk mencatat kehadiran
            Anda.</p>
        ...
        <div class="data-list stagger-2">
            ...
            <div class="data-item">
                ...
                <span class="data-value"><?= date('H:i', strtotime($kegiatan['waktu_mulai'])) ?> -
                    <?= date('H:i', strtotime($kegiatan['waktu_selesai'])) ?></span>
            </div>
            <div class="data-item">
        ...
        <form action="<?= url('absensi/submit') ?>" method="POST" enctype="multipart/form-data" class="stagger-3">
            ...
            <div class="form-group autocomplete-form-group stagger-4">
                <label for="nama_search" class="form-label">Nama Lengkap <span
                ...
                <div class="autocomplete-wrapper" id="autocompleteWrapper">
                    <div class="autocomplete-input-container">
                        ...
                        <input type="text" id="nama_search" class="form-control autocomplete-input"
                            placeholder="Ketik nama pegawai..." autocomplete="off" required>
                        <button type="button" class="autocomplete-clear-btn" id="clearBtn" title="Hapus"
                            style="display: none;">
                            <i class='bx bx-x'></i>
                        </button>
                    </div>
            ...
            <div class="form-group stagger-4">
                ...
                <input type="text" id="display_nip" class="form-control" readonly
            ...
            <div id="section-tidak-hadir" class="fade-section" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alasan_tidak_hadir" id="alasan_tidak_hadir" class="form-control" rows="3"
