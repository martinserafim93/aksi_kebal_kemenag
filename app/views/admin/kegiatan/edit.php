        ...
        <form action="<?= url('admin/kegiatan-edit/' . $kegiatan['kode_kegiatan']) ?>" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
                ...
                <div class="form-group" style="margin-top: 0.5rem;">
                    ...
                    <input type="hidden" id="latitude_kegiatan" name="latitude_kegiatan" value="<?= e($kegiatan['latitude_kegiatan'] ?? '') ?>">
                    <input type="hidden" id="longitude_kegiatan" name="longitude_kegiatan" value="<?= e($kegiatan['longitude_kegiatan'] ?? '') ?>">
...
if (document.getElementById('map')) {
    ...
    // Auto-load lokasi jika sudah ada data
    const savedLat = parseFloat(document.getElementById('latitude_kegiatan').value);
    const savedLng = parseFloat(document.getElementById('longitude_kegiatan').value);
