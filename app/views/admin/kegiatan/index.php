...
<div class="card" >
    <div class="card-body" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
        <div>
            ...
            <p style="margin: 0.25rem 0 0 0; color: var(--text-muted); font-size: 0.95rem;">Kelola data kegiatan, publikasi, dan absensi.</p>
        </div>
        <div>
...
<div class="card" >
    <div class="card-header" >
        <h4 style="margin: 0; font-size: 1.1rem; font-weight: 600; color: var(--text-main); display: flex; align-items: center; gap: 0.5rem;"><i class='bx bx-filter-alt'></i> Filter Pencarian</h4>
    </div>
    <div class="card-body" >
    ...
    <div class="table-responsive" style="overflow-x: auto;">
        <table class="table" style="width: 100%; border-collapse: collapse;">
            <thead style="background: var(--content-bg); border-bottom: 1px solid var(--border-color);">
                <tr>
                    <th width="5%" style="padding: 1rem; font-weight: 600; text-align: center; color: var(--text-muted); text-transform: uppercase; font-size: 0.85rem;">No</th>
                    <th width="20%" style="padding: 1rem; font-weight: 600; text-align: left; color: var(--text-muted); text-transform: uppercase; font-size: 0.85rem;">Nama Kegiatan</th>
                    <th width="15%" style="padding: 1rem; font-weight: 600; text-align: left; color: var(--text-muted); text-transform: uppercase; font-size: 0.85rem;">Jenis</th>
                    <th width="15%" style="padding: 1rem; font-weight: 600; text-align: left; color: var(--text-muted); text-transform: uppercase; font-size: 0.85rem;">Waktu</th>
                    <th width="15%" style="padding: 1rem; font-weight: 600; text-align: left; color: var(--text-muted); text-transform: uppercase; font-size: 0.85rem;">Lokasi</th>
                    <th width="10%" style="padding: 1rem; font-weight: 600; text-align: left; color: var(--text-muted); text-transform: uppercase; font-size: 0.85rem;">Status</th>
                    <th width="20%" style="padding: 1rem; font-weight: 600; text-align: center; color: var(--text-muted); text-transform: uppercase; font-size: 0.85rem;">Aksi</th>
                </tr>
            </thead>
            <tbody>
