...
<div class="card" style="margin-bottom: 2rem;">
    <div class="card-body" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
        ...
        <div>
            <a href="<?= url('admin/pegawai-create') ?>" class="btn btn-primary" style="display: inline-flex; align-items: center; gap: 0.5rem;">
                            ...
                            <tr style="border-bottom: 1px solid var(--border-color);">
                                ...
                                <td style="padding: 1rem; text-align: center;">
                                    <div style="display: flex; gap: 0.5rem; justify-content: center;">
                                        ...
                                        <form action="<?= url('admin/pegawai-delete/' . urlencode($p['nip'])) ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data pegawai ini? Aksi ini tidak dapat dibatalkan.');" style="display: inline-block;">
