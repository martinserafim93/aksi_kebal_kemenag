...
<div class="card" >
    <div class="card-header" >
        <h3 class="card-title" style="font-weight: 600;">Daftar Tim Kerja</h3>
            ...
            <table class="table" style="width: 100%; border-collapse: collapse;">
                <thead style="background: var(--content-bg); border-bottom: 1px solid var(--border-color);">
                    <tr>
                        ...
                        <th style="text-align: left; padding: 1rem; color: var(--text-muted); font-size: 0.85rem; font-weight: 600; text-transform: uppercase;">Nama Tim Kerja</th>
                        <th style="text-align: center; padding: 1rem; color: var(--text-muted); font-size: 0.85rem; font-weight: 600; text-transform: uppercase;">Jumlah Anggota</th>
                            ...
                            <tr style="border-bottom: 1px solid var(--border-color);">
                                ...
                                <td style="padding: 1rem; text-align: center;">
                                    <div style="display: flex; gap: 0.5rem; justify-content: center;">
                                        <a href="<?= url('admin/tim-kerja-edit/' . urlencode($t['slug_tim_kerja'])) ?>" class="btn" style="background: #eff6ff; color: #1d4ed8; padding: 0.4rem 0.6rem; border-radius: 0.25rem;" title="Edit">
                                            <i class='bx bx-edit-alt'></i>
                                        </a>
                                        
                                        <form action="<?= url('admin/tim-kerja-delete/' . urlencode($t['slug_tim_kerja'])) ?>" method="POST" class="form-delete" style="display: inline-block;">
                                            <?= csrfField() ?>
